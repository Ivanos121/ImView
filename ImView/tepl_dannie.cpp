    ...
    ui(new Ui::Tepl_dannie)
{
    ...
    ui->tableWidget->item(10,0)->setText("alpha(sigma) – коэффициент теплоотдачи в воздушном зазоре");

    ui->tableWidget->item(11,0)->setText("z1 – число зубцов статора");
    ui->tableWidget->item(12,0)->setText("bz1 – ширина паза статора, м");
    ui->tableWidget->item(13,0)->setText("lambda(с) – ddd");
    ui->tableWidget->item(14,0)->setText("Hz1 – высота зубца статора, м");
    ui->tableWidget->item(15,0)->setText("lambda(ип1) – коэффициент теплопроводности пазовой изоляции");
    ui->tableWidget->item(16,0)->setText("delta(ип1) – толщина пазовой изоляции");
    ui->tableWidget->item(17,0)->setText("d’ – диаметр провода, м");
    ui->tableWidget->item(18,0)->setText("Кз – коэффициент заполнения паза");
    ui->tableWidget->item(19,0)->setText("delta - ff");
    ui->tableWidget->item(20,0)->setText("lambda(экв) – эквивалентный	 коэффициент теплопроводности обмотки");

    ui->tableWidget->item(21,0)->setText("Bp - fff");
    ui->tableWidget->item(22,0)->setText("sigma(ипр) – толщина изоляции провода, м");
    ui->tableWidget->item(23,0)->setText("teta(м) – допускаемая температура обмотки статора для данного класса нагревостойкости пазовой изоляции");
    ui->tableWidget->item(24,0)->setText("Kп -коэффициент пропитки");
    ui->tableWidget->item(25,0)->setText("Kп2 - fff");
    ui->tableWidget->item(26,0)->setText("d12 - fff");
    ui->tableWidget->item(27,0)->setText("lambda(л) – коэффициент теплопроводности пропиточного лака");
    ui->tableWidget->item(28,0)->setText("lambda(эм) - коэффициент теплопроводности изоляции обмоточного провода");
    ui->tableWidget->item(29,0)->setText("sigma(i) - ddd");
    ui->tableWidget->item(30,0)->setText("lambda_ek - fdff");

    ui->tableWidget->item(31,0)->setText("lambda_c - dd;");
    ui->tableWidget->item(32,0)->setText("lambda(mi) – коэффициент теплопроводности материала обмотки статора");
    ui->tableWidget->item(33,0)->setText("q(mi) – суммарное сечение проводников в пазу статора");
    ui->tableWidget->item(34,0)->setText("z_i - ddd;");
    ui->tableWidget->item(35,0)->setText("Lp1 - fff;");
    ui->tableWidget->item(36,0)->setText("lambda(ил1) – коэффициент теплопроводности лобовых частей");
    ui->tableWidget->item(37,0)->setText("Kл1 – коэффициент обдува лобовых частей");
    ui->tableWidget->item(38,0)->setText("delta(ил1) – толщина изоляции лобовых частей");
    ui->tableWidget->item(39,0)->setText("lambda_ekuz - fff");
    ui->tableWidget->item(40,0)->setText("lambda_ekpa - fff;");

    ui->tableWidget->item(41,0)->setText("L_li - fff;");
    ui->tableWidget->item(42,0)->setText("alpha(л1) – средний коэффициент теплоотдачи с лобовых частей;");
    ui->tableWidget->item(43,0)->setText("lambda(м2) – коэффициент теплопроводности материала обмотки");
    ui->tableWidget->item(44,0)->setText("qc – сечение стержня клетки ротора");
    ui->tableWidget->item(45,0)->setText("Z2 - dcdd");
    ui->tableWidget->item(46,0)->setText("L2 - fff");
    ui->tableWidget->item(47,0)->setText("Bk - fff");
    ui->tableWidget->item(48,0)->setText("alpha(а2) – коэффициент теплоотдачи с поверхности лобовых частей обмотки ротора");
    ui->tableWidget->item(49,0)->setText("S(л2) – поверхность двух лобовых частей обмотки ротора");
    ui->tableWidget->item(50,0)->setText("alpha(ащ) – средний коэффициент теплоотдачи с внутренней поверхности подшипникового щита");

    ui->tableWidget->item(51,0)->setText("S(iщ) – площадь внутренней поверхности двух подшипниковых щитов");
    ui->tableWidget->item(52,0)->setText("alpha(аст) – средний коэффициент теплоотдачи с внутренней поверхности станины");
    ui->tableWidget->item(53,0)->setText("alpha(ст) – коэффициент конвективной теплоотдачи станины");
    ui->tableWidget->item(54,0)->setText("alpha(r) – коэффициент теплоотдачи излучением");
    ui->tableWidget->item(55,0)->setText("Dст – наружный диаметр станины");
    ui->tableWidget->item(56,0)->setText("Kpп – коэффициент оребрения станины с учетом внутреннего теплового сопротивления ребер");
