    ...
    ui(new Ui::Tepl_dannie)
{
    ...
    ui->tableWidget->item(40,0)->setText("alpha(л1) – средний коэффициент теплоотдачи с лобовых частей;");
    ui->tableWidget->item(41,0)->setText("lambda(м2) – коэффициент теплопроводности материала обмотки");
    ui->tableWidget->item(42,0)->setText("qc – сечение стержня клетки ротора");
    ui->tableWidget->item(43,0)->setText("Z2 - dcdd");
    ui->tableWidget->item(44,0)->setText("L2 - fff");
    ui->tableWidget->item(45,0)->setText("Bk - fff");
    ui->tableWidget->item(46,0)->setText("alpha(а2) – коэффициент теплоотдачи с поверхности лобовых частей обмотки ротора");
    ui->tableWidget->item(47,0)->setText("S(л2) – поверхность двух лобовых частей обмотки ротора");
    ui->tableWidget->item(48,0)->setText("alpha(ащ) – средний коэффициент теплоотдачи с внутренней поверхности подшипникового щита");
    ui->tableWidget->item(49,0)->setText("S(iщ) – площадь внутренней поверхности двух подшипниковых щитов");

    ui->tableWidget->item(50,0)->setText("alpha(аст) – средний коэффициент теплоотдачи с внутренней поверхности станины");
    ui->tableWidget->item(51,0)->setText("alpha(ст) – коэффициент конвективной теплоотдачи станины");
    ui->tableWidget->item(52,0)->setText("alpha(r) – коэффициент теплоотдачи излучением");
    ui->tableWidget->item(53,0)->setText("Dст – наружный диаметр станины");
